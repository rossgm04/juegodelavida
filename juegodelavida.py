...
# Constantes
ANCHO = int(input("Introduce el ancho de la cuadrícula: "))   # Ancho de la cuadrícula
ALTO = int(input("Introduce el alto de la cuadrícula: "))  # Alto de la cuadrícula

VIVO = input("Introduce el carácter para indicar que una célula está viva: ")  # Carácter para la celda viva
